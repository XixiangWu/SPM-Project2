            ...
            <div class="col-sm-6 col-sm-offset-3">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Original Date and Time</h3> </div>
                    <div id="originalDateTime" class="panel-body"></div>
                </div>
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Preffered Date</h3> </div>
                    <div id="datePicker" class="panel-body">Time you preferred</div>
                </div>
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Preffered Time</h3> </div>
                    <div id="timePicker" class="panel-body"></div>
                </div>
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">User ID</h3> </div>
                    <div id="id" class="panel-body"></div>
                </div>
                <button onClick="alter_appointment()" type="button">Alter the Time!</button>
                <button onClick="cancel_appointment()" type="button">Cancel the Appointment</button>
...
//    window.onload = retrieve_user_profile();
    ...
    function retrieveOriDateTime() {
        ...
        $.ajax({
            ...
            , success: function (res) {
                document.getElementById("originalDateTime").innerHTML = res;
            }
        });
    }
