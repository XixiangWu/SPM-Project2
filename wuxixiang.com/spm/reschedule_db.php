<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($_POST['op'] == "REMO") {
            ...
            $id = $_POST['ori_id'];
            $user_sql = "DELETE FROM `appointment_db` WHERE id = $id";
            echo $user_sql;
            mysqli_query($db,$user_sql);  
            return;
         ...
         if ($_POST['op'] == "ALTE") {
            ...
            $user_sql = "UPDATE `appointment_db` SET `time` = '$new_dateTime' WHERE `appointment_db`.`id` = $id";
            mysqli_query($db,$user_sql);  
            return;
        ...
        if ($_POST['op'] == "ORDT") {        
            ...
            $id = $_POST['id'];
            $user_sql = "SELECT * FROM `appointment_db` WHERE `id` = $id";
            $ordt_result = mysqli_query($db,$user_sql); 
            $row = mysqli_fetch_array($ordt_result,MYSQLI_ASSOC);
//            echo $user_sql;
            echo $row['time'];
            return;
